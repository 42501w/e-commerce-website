...
const SuccessPage = () => {
  ...
  return (
    <div className="py-10 bg-gradient-to-br from bg-gray-50 to-gray-100 flex items-center justify-center p-4 ">
      <motion.div
      ...
      >
        ...
        <div className="space-y-4 mb-8 text-left">
          ...
          <p className="text-gray-700">
            ...
            ship it soon. A confirmation email with your order details will sent
