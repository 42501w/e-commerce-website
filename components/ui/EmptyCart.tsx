  ...
  return (
    <div className="py-10 md:py-20 bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
      ...
      >
        ...
        <Link href={'/shop'} className="block bg-black/5 border border-black/20 text-center py-2 rounded-full text-sm font-semibold tracking-wide hover:bg-black hover:border-black hover:text-white hoverEffect">Discover Products </Link>
      </motion.div>
    </div>
  );
};
